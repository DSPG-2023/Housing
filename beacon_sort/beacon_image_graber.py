...
# There is a scraper that exists that grabbed a bunch of info from beacon and threw it into a csv file (not sure where the scraper is)
...
if city_being_evaluated == 2:
    ...
    img_download_loc = os.path.expanduser('~/Documents/downloaded_beacon_images/beacon_independence')
else:
...
for index, row in df.iterrows():
    ...
    rename = f"B_D_{address_min_town}_.jpeg"
    print(rename)
