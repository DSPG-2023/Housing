...
data_path = os.path.expanduser("~/Documents/pets")
...
torch.save(model.state_dict(), 'cam_pets_model.pth')
...
model.load_state_dict(torch.load('cam_pets_model.pth'))
model.to(device)
model.eval()
...
image_path = os.path.expanduser('~/Documents/pets_test/cat.png')
# image_path = os.path.expanduser('~/Documents/pets_test/dog.png')
# image_path = os.path.expanduser('~/Documents/pets_test/dog_2.png')
...
predicted_label = 'cat' if output.item() >= threshold else 'dog'
